            ...
            <nav className="border-gray-900  lg:px-6 py-4 bg-fuchsia-500 text-white">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        <Link
                            to="logout"
                            className="text-white hover:bg-gray-300 hover:text-purple-950 focus:ring-4 focus:ring-gray-300 font-bold rounded-lg text-lg px-4 lg:px-4 py-2 lg:py-2.5 mr-2 focus:outline-none"
                        >
                           Logout
                        </Link>
